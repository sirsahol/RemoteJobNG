  ...
  return (
    <main className="min-h-screen pt-32 pb-20">
      ...
      <section className="max-w-6xl mx-auto px-4 mb-32">
        <div className="glass-card p-12 md:p-20 border-glass-border relative overflow-hidden group">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex gap-4">
                ...
                <div className="w-4 h-1 bg-text-muted/10 rounded-full"></div>
                <div className="w-4 h-1 bg-text-muted/10 rounded-full"></div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
               <div className="glass-card p-6 bg-bg-page/5 border-glass-border">
                 <p className="text-2xl font-black text-text-main mb-1">50K+</p>
                 <p className="text-[10px] font-black text-text-muted/40 uppercase tracking-widest">Active Seekers</p>
               </div>
               <div className="glass-card p-6 bg-bg-page/5 border-glass-border">
                 <p className="text-2xl font-black text-text-main mb-1">2.4k</p>
                 <p className="text-[10px] font-black text-text-muted/40 uppercase tracking-widest">Daily Jobs</p>
               </div>
               <div className="glass-card p-6 bg-bg-page/5 border-glass-border">
                 <p className="text-2xl font-black text-text-main mb-1">100%</p>
                 <p className="text-[10px] font-black text-text-muted/40 uppercase tracking-widest">Remote-Only</p>
               </div>
               <div className="glass-card p-6 bg-bg-page/5 border-glass-border">
                 <p className="text-2xl font-black text-text-main mb-1">Top 5</p>
                 <p className="text-[10px] font-black text-text-muted/40 uppercase tracking-widest">Global Sourcing</p>
               </div>
            </div>
          </div>
        </div>
      ...
      {/* Feature Protocol */}
      <section className="max-w-6xl mx-auto px-4 mb-32">
        <h2 className="text-[10px] font-black text-text-muted/40 uppercase tracking-[0.4em] mb-12 text-center">Protocol Capabilities</h2>
