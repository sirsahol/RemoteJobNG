    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_slug', models.SlugField(blank=True, max_length=150, unique=True)),
                ...
                ('availability', models.CharField(blank=True, choices=[('available', 'Available Now'), ('open', 'Open to Opportunities'), ('not_available', 'Not Available')], default='open', max_length=20)),
